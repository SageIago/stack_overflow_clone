...
export const QuestionsSchema = z.object({
    ...
    explanation: z.string().min(100, {message: "Explanation of the Problem must bre greater than 100 characters"}).max(500, {message: "Explanation of the Problem must be less than 500 characters"}),
