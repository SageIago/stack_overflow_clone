            ...
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl className="mt-3.5">
                <Input
                  ...
                  {...field}
                  className="no-focus paragraph-regular background-light700_dark300 text-dark300_light700 light-border-2 min-h-[56px] rounded-[6px] border"
                />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Introduce the Problem and expand on what you defined on the
              ...
              <FormControl className="mt-3.5">
                <>
                  <Input
                    ...
                    className="no-focus paragraph-regular background-light900_dark300 text-dark300_light700 light-border-2 min-h-[56px] rounded-[6px] border"
                  ...
                  {field.value.length > 0 && (
                    <div className="flex-start mt-2.5 gap-2.5">
                      {field?.value.map((tag: string) => (
                        <Badge
                          key={tag}
                          className="subtle-medium background-light800_dark300 text-light400_light500 mt-3 flex items-center justify-center gap-2.5 rounded-[6px] border-none px-5 py-3 capitalize"
                        >
                          {tag}
                          <Image
                            src={CloseIcon}
